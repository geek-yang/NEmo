...
Function     : Emotion recognition and forecast with ConvLSTM
Author       : Yang Liu & Tianyi Zhang
Contributor  : Tianyi Zhang (Centrum Wiskunde & Informatica)
First Built  : 2021.02.27
Last Update  : 2021.03.01
Library      : Pytorth, Numpy, os, NEmo, matplotlib
Description  : This script serves to test the prediction skill of deep neural networks in emotion recognition and forecast. The convolutional Long Short Time Memory neural network is used to deal with this spatial-temporal sequence problem. We use Pytorch as the deep learning framework.
